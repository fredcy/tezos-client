		...
		var helper = F2(
			function (hash, blockList) {
				...
				while (true) {
					...
					if (_p0.ctor === 'Just') {
						var _p1 = _p0._0;
						if (_elm_lang$core$Native_Utils.eq(_p1.predecessor, hash)) {
							return blockList;
						} else {
							var _v1 = _p1.predecessor,
								_v2 = {ctor: '::', _0: _p1, _1: blockList};
							hash = _v1;
							blockList = _v2;
							continue helper;
						}
...
var _user$project$Update$getBlock = F2(
	function (model, hash) {
		var _p0 = A2(_elm_lang$core$Dict$get, hash, model.chain.blocks);
		if (_p0.ctor === 'Nothing') {
			return A2(
				_elm_lang$http$Http$send,
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								pageState: _user$project$Model$Loaded(
									_user$project$Page$Block(_p2))
							}),
						_1: A2(_user$project$Update$getBlock, model, _p2)
					};
				case 'Operations':
					return {
						ctor: '_Tuple2',
		...
		switch (_p3._0.ctor) {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								schemaData: A3(
									_elm_lang$core$Dict$insert,
									_p3._0._0,
									_user$project$Data_Schema$collapseTrees(_p5._0),
									model.schemaData)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'SchemaMsg':
				...
				var newSchemaMaybe = A2(
					_elm_lang$core$Maybe$map,
					_user$project$Data_Schema$update(_p3._0._1),
			...
			case 'LoadOperation':
				var _p9 = _p3._0._0;
				if (_p9.ctor === 'Ok') {
					var newChain = A2(_user$project$Data_Chain$loadOperation, model.chain, _p9._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'LoadParsedOperation':
				var _p10 = _p3._0._1;
				if (_p10.ctor === 'Ok') {
					var newChain = A3(_user$project$Data_Chain$loadParsedOperation, model.chain, _p3._0._0, _p10._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				if (_p11.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chain: A3(_user$project$Data_Chain$addBlockOperations, model.chain, _p3._0._0, _p11._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'ShowBlock':
				...
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A2(_user$project$Update$getBlockOperationDetails, model, _p13),
							_1: {
								ctor: '::',
								_0: _user$project$Route$newUrl(
									_user$project$Route$Block(_p13)),
								_1: {ctor: '[]'}
							}
						})
				};
			...
			case 'Tick':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							now: _elm_lang$core$Date$fromTime(_p3._0._0)
						}),
					_1: A2(
						_elm_lang$http$Http$send,
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(operation.net_id),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
		...
		if (_p4.ctor === 'Just') {
			return A2(
				...
				A2(
					...
					_elm_lang$core$List$concat(_p4._0)));
		} else {
...
var _user$project$View$blockOperationCount = function (block) {
	var _p5 = block.operations;
	if (_p5.ctor === 'Just') {
		return _elm_lang$core$Basics$toString(
			_elm_lang$core$List$length(
				_elm_lang$core$List$concat(_p5._0)));
	} else {
		return 'unknown';
	}
};
...
var _user$project$View$viewShowBranch = function (model) {
	...
	if (_p6.ctor === 'Just') {
		return A4(
			...
			model.now,
			model.showBlock,
			A2(_user$project$Data_Chain$getBranchList, model.chain, _p6._0));
	} else {
		return A2(
			_elm_lang$html$Html$h4,
			{ctor: '[]'},
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A4(
						...
						A2(_user$project$Data_Chain$getBranchList, model.chain, _p9)),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _user$project$View$findBlockStatus = F2(
	function (blocks, blockhash) {
		var _p10 = A2(_elm_lang$core$Dict$get, blockhash, blocks);
		if (_p10.ctor === 'Just') {
			return _user$project$View$BlockFound(_p10._0);
		} else {
...
var _user$project$View$viewHeads = function (model) {
	...
	var viewHead = F2(
		function (i, blockStatus) {
			var _p11 = blockStatus;
			if (_p11.ctor === 'BlockFound') {
				var _p12 = _p11._0;
				return A3(
					viewBlockSummary,
					i,
					_p12,
					A2(isBeingShown, model.showBranch, _p12.hash));
			} else {
				return _elm_lang$html$Html$text('');
			}
		});
	...
	var content = function () {
		...
		switch (_p13._0.ctor) {
			...
			case 'Block':
				...
				if (_p14.ctor === 'Just') {
					return _user$project$View$viewBlock(_p14._0);
				} else {
