...
var _user$project$Data_Chain$loadContractError = F2(
	function (model, error) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				contract: _krisajenkins$remotedata$RemoteData$Failure(error)
			});
	});
var _user$project$Data_Chain$loadContract = F3(
	function (model, contractId, contract) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				contract: _krisajenkins$remotedata$RemoteData$Success(contract),
				contracts: A3(_elm_lang$core$Dict$insert, contractId, contract, model.contracts)
			});
	});
var _user$project$Data_Chain$loadingContract = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{contract: _krisajenkins$remotedata$RemoteData$Loading});
};
...
var _user$project$Data_Chain$Delegate = F2(
	function (a, b) {
		return {value: a, setable: b};
	});
var _user$project$Data_Chain$decodeDelegate = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'setable',
	_elm_lang$core$Json_Decode$bool,
	A3(
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {heads: a, blocks: b, operations: c, parsedOperations: d, blockOperations: e, contractIDs: f, keys: g, peers: h, contract: i, contracts: j};
									};
								};
							};
						};
				...
				case 'Block':
					...
					return {
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: A2(_user$project$Update$getBlock, model, _p4),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Update$getBlockOperationDetails, model, _p4),
									_1: {ctor: '[]'}
								}
							})
					};
				...
				case 'Contract':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Model$Loaded(
									_user$project$Page$Contract(_p6)),
								chain: _user$project$Data_Chain$loadingContract(model.chain)
							}),
						_1: A2(
							_elm_lang$http$Http$send,
							_user$project$Update$LoadContract(_p6),
							A2(_user$project$Request_Block$getContract, model.nodeUrl, _p6))
					};
				case 'Schema':
...
var _user$project$Update$loadHeads = F2(
	function (model, headsData) {
		...
		var showBranch = _elm_lang$core$List$head(newChain.heads);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
			...
			_1: A2(
				...
				A2(
					_elm_lang$core$Maybe$map,
					_user$project$Update$getBranch(model),
					showBranch))
		};
	});
	...
	function (page, msg, model) {
		...
		switch (_p7._0.ctor) {
			case 'LoadBlocks':
				var _p8 = _p7._0._0;
				if (_p8.ctor === 'Ok') {
					return A2(_user$project$Update$loadBlocks, model, _p8._0);
				} else {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								schemaData: A3(
									_elm_lang$core$Dict$insert,
									_p7._0._0,
									_user$project$Data_Schema$collapseTrees(_p9._0),
									model.schemaData)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errors: {
									ctor: '::',
									_0: _user$project$Model$HttpError(_p9._0),
									_1: model.errors
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'SchemaMsg':
				...
				var newSchemaMaybe = A2(
					_elm_lang$core$Maybe$map,
					_user$project$Data_Schema$update(_p7._0._1),
					A2(_elm_lang$core$Dict$get, _p12, model.schemaData));
				var _p10 = newSchemaMaybe;
				if (_p10.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								schemaData: A3(_elm_lang$core$Dict$insert, _p12, _p10._0, model.schemaData)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p11 = A2(_elm_lang$core$Debug$log, 'Failed to find schema', _p12);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'LoadOperation':
				var _p13 = _p7._0._0;
				if (_p13.ctor === 'Ok') {
					var newChain = A2(_user$project$Data_Chain$loadOperation, model.chain, _p13._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errors: {
									ctor: '::',
									_0: _user$project$Model$HttpError(_p13._0),
									_1: model.errors
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'LoadParsedOperation':
				var _p14 = _p7._0._1;
				if (_p14.ctor === 'Ok') {
					var newChain = A3(_user$project$Data_Chain$loadParsedOperation, model.chain, _p7._0._0, _p14._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				if (_p15.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chain: A3(_user$project$Data_Chain$addBlockOperations, model.chain, _p7._0._0, _p15._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'LoadHeads':
				var _p16 = _p7._0._0;
				if (_p16.ctor === 'Ok') {
					return A2(_user$project$Update$loadHeads, model, _p16._0);
				} else {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
			...
			case 'LoadChainAt':
				var _p17 = _p7._0._1;
				if (_p17.ctor === 'Ok') {
					return A2(_user$project$Update$loadBlocks, model, _p17._0);
				} else {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errors: {
									ctor: '::',
									_0: _user$project$Model$HttpError(_p17._0),
									_1: model.errors
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
				...
				if (_p18.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chain: A2(_user$project$Data_Chain$loadContractIDs, model.chain, _p19)
							}),
						_1: A2(_user$project$Update$getContractDetails, model.nodeUrl, _p19)
					};
				} else {
					var _p20 = _p18._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errors: {
									ctor: '::',
									_0: _user$project$Model$HttpError(_p20),
									_1: model.errors
								},
								chain: A2(_user$project$Data_Chain$loadContractIDsError, model.chain, _p20)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p21.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chain: A2(_user$project$Data_Chain$loadKeys, model.chain, _p21._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								chain: A2(_user$project$Data_Chain$loadKeysError, model.chain, _p22)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p23.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chain: A2(_user$project$Data_Chain$loadPeers, model.chain, _p23._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								chain: A2(_user$project$Data_Chain$loadPeersError, model.chain, _p24)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p25.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chain: A3(_user$project$Data_Chain$loadContract, model.chain, _p7._0._0, _p25._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								chain: A2(_user$project$Data_Chain$loadContractError, model.chain, _p26)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'Tick':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							now: _elm_lang$core$Date$fromTime(_p7._0._0)
						}),
					_1: A2(
						_elm_lang$http$Http$send,
			...
			case 'SetRoute':
				return A2(_user$project$Update$setRoute, _p7._0._0, model);
			case 'ClearErrors':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				var _p27 = A2(_user$project$Update$updateMonitor, _p7._0._0, model);
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_user$project$View$formatCentiles(_p5.balance)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												ctor: '::',
												_0: _user$project$Route$href(
													_user$project$Route$Contract(_p5.manager)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_user$project$View$shortHash(_p5.manager)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_elm_lang$core$Basics$toString(_p5.counter)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('script prefix'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: function () {
					var _p6 = model.chain.contractIDs;
					switch (_p6.ctor) {
						case 'Success':
							return A2(_user$project$View$viewContractTable, _p6._0, model.chain.contracts);
						case 'Loading':
							return _elm_lang$html$Html$text('loading ...');
						default:
							return _elm_lang$html$Html$text(
					...
					_1: {
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$View$shortHash(_p7._0)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$View$formatInt(_p7._1)),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$title(_p8),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('hash'),
											_1: {ctor: '[]'}
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_user$project$View$shortHash(_p8)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		if (_p9.ctor === 'Just') {
			return A2(
				...
				A2(
					...
					A2(_elm_lang$core$Dict$get, _p9._0, blockOperations)));
		} else {
			return _elm_lang$html$Html$text('');
		}
	});
...
var _user$project$View$viewConnection = function (connectionM) {
	...
	if (_p10.ctor === 'Just') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$View$viewAddress(_p11.addr),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(' '),
					_1: {
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$View$formatDate(_p11.time)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			_1: {
				...
				_0: function () {
					...
					if (_p12.ctor === 'Success') {
						return _user$project$View$viewPeersList(_p12._0);
					} else {
						return _elm_lang$html$Html$text(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: function () {
						var _p14 = operationMaybe;
						if (_p14.ctor === 'Just') {
							return viewOperationFields(_p14._0);
						} else {
...
var _user$project$View$viewContract = F2(
	function (contractId, contractData) {
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(delegate.value),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(_p16.manager),
													_1: {ctor: '[]'}
												})),
										_1: {
											ctor: '::',
											_0: A2(
												...
												'balance',
												_elm_lang$html$Html$text(
													_user$project$View$formatInt(_p16.balance))),
											_1: {
												ctor: '::',
												_0: A2(
													_user$project$View$viewProperty,
													'spendable',
													_elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(_p16.spendable))),
												_1: {
													ctor: '::',
													_0: A2(
														_user$project$View$viewProperty,
			...
			if (_p17.ctor === 'Just') {
				return A2(
					...
					A2(
						...
						_elm_lang$core$List$concat(_p17._0)));
			} else {
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A4(
						...
						A2(_user$project$Data_Chain$getBranchList, model.chain, _p20)),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _user$project$View$findBlockStatus = F2(
	function (blocks, blockhash) {
		var _p21 = A2(_elm_lang$core$Dict$get, blockhash, blocks);
		if (_p21.ctor === 'Just') {
			return _user$project$View$BlockFound(_p21._0);
		} else {
...
var _user$project$View$viewHeads = function (model) {
	...
	var viewHead = F2(
		function (i, blockStatus) {
			var _p22 = blockStatus;
			if (_p22.ctor === 'BlockFound') {
				return A2(viewBlockSummary, i, _p22._0);
			} else {
				return _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'block ',
						A2(_elm_lang$core$Basics_ops['++'], _p22._0, ' not found')));
			}
		});
	var header = A2(
		_elm_lang$html$Html$tr,
...
var _user$project$View$view = function (model) {
	var content = function () {
		...
		switch (_p23._0.ctor) {
			...
			case 'Operation':
				return A2(_user$project$View$viewOperation, model, _p23._0._0);
			case 'Schema':
			...
			case 'Block':
				var _p24 = A2(_elm_lang$core$Dict$get, _p23._0._0, model.chain.blocks);
				if (_p24.ctor === 'Just') {
					return A2(_user$project$View$viewBlock, model, _p24._0);
				} else {
					return _elm_lang$html$Html$text('loading block ...');
				}
			case 'ChainAt':
				return A2(_user$project$View$viewChainAt, model, _p23._0._0);
			case 'Contracts':
			...
			case 'Contract':
				return A2(_user$project$View$viewContract, _p23._0._0, model.chain.contract);
			case 'Errors':
