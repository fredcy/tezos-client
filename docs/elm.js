...
var _user$project$Main$Block = F5(
	function (a, b, c, d, e) {
		return {hash: a, predecessor: b, fitness: c, timestamp: d, operations: e};
	});
var _user$project$Main$decodeBlock = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$Main$Block,
	A2(_elm_lang$core$Json_Decode$field, 'hash', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'predecessor', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'fitness',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)),
	A2(_elm_lang$core$Json_Decode$field, 'timestamp', _user$project$Main$decodeTimestamp),
	A2(
		_elm_lang$core$Json_Decode$field,
		'operations',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
...
var _user$project$Main$getOperations = function (nodeUrl) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
	...
	return A3(
		...
		A2(_elm_lang$core$Basics_ops['++'], nodeUrl, '/operations'),
		body,
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {blocks: a, schemaData: b, errors: c, nodeUrl: d, operations: e, parsedOperations: f, showBlock: g, showOperation: h, showBranch: i, levels: j, schemaQuery: k};
										};
									};
								};
							};
...
var _user$project$Main$viewHeads = F2(
	function (branches, levels) {
												...
												_0: _elm_lang$html$Html$text(
													A2(
														...
														A2(
															_elm_lang$core$Maybe$map,
															_elm_lang$core$Basics$toString,
															A2(_elm_lang$core$Dict$get, block.hash, levels)))),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A2(viewOperations, 'operations', block.operations),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(
										_elm_lang$core$List$length(block.operations))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$SchemaMsg = function (a) {
	return {ctor: 'SchemaMsg', _0: a};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$viewHeads, model.blocks, model.levels),
					_1: {
						ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: function () {
											var _p15 = model.schemaData;
											if (_p15.ctor === 'Just') {
												return A2(
													_elm_lang$html$Html$map,
													_user$project$Main$SchemaMsg,
													A2(_user$project$Schema$viewSchemaDataTop, model.schemaQuery, _p15._0));
											} else {
												return _elm_lang$html$Html$text('');
											}
										}(),
...
var _user$project$Main$getLevelCommands = F2(
	function (nodeUrl, branches) {
		return _elm_lang$core$Platform_Cmd$batch(
			A2(
				_elm_lang$core$List$map,
				_user$project$Main$getLevelCommand(nodeUrl),
				A2(_elm_lang$core$List$filterMap, _user$project$Main$getHeadId, branches)));
	});
	...
	function (msg, model) {
		...
		switch (_p17.ctor) {
				...
				if (_p18.ctor === 'Ok') {
					...
					return {
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: A2(_user$project$Main$getLevelCommands, model.nodeUrl, _p19),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$getBlocksOperationsDetail, model, _p19),
									_1: {ctor: '[]'}
								}
							})
					};
			...
			case 'LoadLevel':
				var _p20 = _p17._1;
				if (_p20.ctor === 'Ok') {
					var newLevels = A3(_elm_lang$core$Dict$insert, _p17._0, _p20._0, model.levels);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								schemaData: _elm_lang$core$Maybe$Just(
									_user$project$Schema$collapseTrees(_p21._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'SchemaMsg':
				var newSchema = A2(_user$project$Schema$update, _p17._0, model.schemaData);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
				...
				if (_p22.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								operations: A3(_elm_lang$core$Dict$insert, _p23.hash, _p23, model.operations)
							}),
						_1: A2(_user$project$Main$getParseOperationCommand, model.nodeUrl, _p23)
					};
				} else {
					return {
						ctor: '_Tuple2',
				...
				if (_p24.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								parsedOperations: A3(_elm_lang$core$Dict$insert, _p17._0, _p24._0, model.parsedOperations)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errors: {ctor: '::', _0: _p24._0, _1: model.errors}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'ShowBlock':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							showBlock: _elm_lang$core$Maybe$Just(_p25)
						}),
					_1: A2(_user$project$Main$getBlockOperationInfo, model, _p25)
				};
			case 'ShowOperation':
				var _p26 = _p17._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							showOperation: _elm_lang$core$Maybe$Just(_p26)
						}),
					_1: A3(_user$project$Main$getOperationIfNew, model.nodeUrl, model.operations, _p26)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							showBranch: _elm_lang$core$Maybe$Just(_p17._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
