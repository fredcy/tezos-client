				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							A2(_elm_lang$core$List$indexedMap, _user$project$Main$viewBlock, branch)),
						_1: {ctor: '[]'}
					}
				});
		});
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Connecting to server ', nodeUrl)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {blocks: a, schemaData: b, errors: c, nodeUrl: d, operations: e};
	});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
				...
				if (_p6.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								schemaData: _elm_lang$core$Maybe$Just(_p6._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'SchemaMsg':
				var newSchema = A2(_user$project$Schema$update, _p4._0, model.schemaData);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
				...
				if (_p7.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								operations: _user$project$Main$Success(_p7._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								operations: _user$project$Main$Failure(_p7._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p8 = model.schemaData;
								if (_p8.ctor === 'Just') {
									return A2(
										_elm_lang$html$Html$map,
										_user$project$Main$SchemaMsg,
										_user$project$Schema$viewSchemaDataTop(_p8._0));
								} else {
									return _elm_lang$html$Html$text('');
								}
							}(),
