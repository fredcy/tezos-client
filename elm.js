		...
		if (_p2.ctor === 'Just') {
			return A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$viewErrorInfo, nodeUrl, _p2._0),
						_1: {ctor: '[]'}
					}
				});
		} else {
...
var _user$project$Main$viewBlocks = function (branches) {
	var header = {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Block chain'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
				...
				if (_p4.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{blocks: _p4._0, error: _elm_lang$core$Maybe$Nothing}),
				...
				if (_p5.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								schemaData: _elm_lang$core$Maybe$Just(_p5._0),
			...
			case 'SchemaMsg':
				var newSchema = A2(_user$project$Schema$update, _p3._0, model.schemaData);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {blocks: a, schemaData: b, error: c, nodeUrl: d};
	});
var _user$project$Main$Block = F4(
	function (a, b, c, d) {
		return {hash: a, predecessor: b, fitness: c, timestamp: d};
	});
var _user$project$Main$decodeBlock = A5(
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$viewError, model.nodeUrl, model.error),
				_1: {
					ctor: '::',
					_0: function () {
						var _p6 = model.schemaData;
						if (_p6.ctor === 'Just') {
							return A2(
								_elm_lang$html$Html$map,
								_user$project$Main$SchemaMsg,
								_user$project$Schema$viewSchemaDataTop(_p6._0));
						} else {
							return _elm_lang$html$Html$text('');
						}
					}(),
